...
public partial class WestWindContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__BuildVer__3214EC07A235B1C3");
        ...
        {
            entity.HasKey(e => e.ManifestItemId).HasName("PK__Manifest__9000192CDBBE293D");
        ...
        {
            entity.HasKey(e => e.ShipmentId).HasName("PK__Shipment__5CAD378DA0506EE6");
